/* GENERATED HANDLER FILE -- DO NOT EDIT (2020-09-12T21:12:40.086730Z) */
...
CASE(_profile_ifeq): { // profile_ifeq
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifeq(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifeq handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifne): { // profile_ifne
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifne(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifne handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_iflt): { // profile_iflt
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_iflt(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_iflt handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifge): { // profile_ifge
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifge(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifge handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifgt): { // profile_ifgt
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifgt(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifgt handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifle): { // profile_ifle
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifle(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifle handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmpeq): { // profile_if_icmpeq
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmpeq(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmpeq handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmpne): { // profile_if_icmpne
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmpne(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmpne handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmplt): { // profile_if_icmplt
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmplt(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmplt handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmpge): { // profile_if_icmpge
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmpge(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmpge handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmpgt): { // profile_if_icmpgt
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmpgt(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmpgt handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_icmple): { // profile_if_icmple
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_icmple(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_icmple handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_acmpeq): { // profile_if_acmpeq
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_acmpeq(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_acmpeq handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_if_acmpne): { // profile_if_acmpne
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_if_acmpne(pc+0,0); }
  { INSTR_end_sequence(pc+8,-2); }
  puts("Overrun of profile_if_acmpne handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile__goto): { // profile__goto
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_goto(pc+0,0); }
  puts("Overrun of profile__goto handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_jsr): { // profile_jsr
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_jsr(pc+0,0); }
  puts("Overrun of profile_jsr handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ret): { // profile_ret
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ret(pc+0,0); }
  puts("Overrun of profile_ret handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifnull): { // profile_ifnull
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifnull(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifnull handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_ifnonnull): { // profile_ifnonnull
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_ifnonnull(pc+0,0); }
  { INSTR_end_sequence(pc+8,-1); }
  puts("Overrun of profile_ifnonnull handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_goto_w): { // profile_goto_w
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_goto_w(pc+0,0); }
  puts("Overrun of profile_goto_w handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
CASE(_profile_jsr_w): { // profile_jsr_w
#undef WITH_PROFILE
#define WITH_PROFILE true

  { INSTR_jsr_w(pc+0,0); }
  puts("Overrun of profile_jsr_w handler");
#undef WITH_PROFILE
#define WITH_PROFILE false
}
